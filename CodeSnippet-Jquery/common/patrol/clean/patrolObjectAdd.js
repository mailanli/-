...
$(document).ready(function () {
  ...
  if (patrolId) {
    ...
    $.adapter_get('', 'cleanPatrolObjects/info/' + patrolId, function (d) {
      var data = d.data
...
function patrolObjectSave(edits) {
  ...
  if (edits) {
    $.adapter_post(param, 'cleanPatrolObjects/update', function (d) {
      initResult(d)
    })
  } else {
    $.adapter_post(param, 'cleanPatrolObjects/save', function (d) {
      initResult(d)
    })
  }
}
...
function goBack() {
  ...
  path = '/integration-admin/common/patrol/clean/patrolObject.html'
