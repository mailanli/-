$(document).ready(function () {
    ...
    var pointInfoUrl;
    alert(sessionStorage.getItem('objectType'))
    switch(sessionStorage.getItem('objectType')){
      case "1":
        pointInfoUrl = 'globalPatrolObjects/pointInfo/'
        break;
      case "2":
        pointInfoUrl = 'greenPatrolObjects/pointInfo/'
        break;
      default:
        pointInfoUrl = 'cleanPatrolObjects/pointInfo/'
      }
    $.adapter_get('', pointInfoUrl + targetID, function (d) {
        var detailsData = d.data;
        $("#patrol-object-details").html('')
        var marks = [];
        console.log("aa",detailsData.length)
        for (var i = 0; i < detailsData.length; i++) {
            ...
            var str = '?objectsId=' + targetID + '&pointId=' + detailsData[i].pointId;
...
function goBack() {
  ...
  switch(sessionStorage.getItem('objectType')){
  case "1":
    var path = '/integration-admin/common/patrol/global/patrolObject.html'
    break;
  case "2":
    var path = '/integration-admin/common/patrol/green/patrolObject.html'
    break;
  default:
    var path = '/integration-admin/common/patrol/clean/patrolObject.html'
  }
