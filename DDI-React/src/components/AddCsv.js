	...
	render() {
		...
		return (
			<Form onSubmit={this.handleSubmit}>
	          ...
	          >
	          {
	             <Radio.Group defaultValue="csv" onChange={this.handleFormLayoutChange}>
	          ...
	          <FormItem
		          ...
		          <FormItem
			        ...
			        >
	          		...
	          		<FormItem
			            ...
			            {...formItemLayout}
			          >
			            <Radio.Group defaultValue="windows" onChange={this.handleFormObjectTypeChange} className="left">
			              <Radio.Button value="windows" >CR+LF(Windows,DOS)</Radio.Button>
			              <Radio.Button value="unix">LF(Unix)</Radio.Button>
			              <Radio.Button value="Mac">CR(Mac)</Radio.Button>
			            </Radio.Group>
			            <span className="ant-form-text"> <i className=" icon-question-sign"></i></span>
		          </FormItem>
		          <FormItem
	           ...
	           {...formItemLayout}>
		        ...
		        <div className="selectBox">
					<FormItem {...formItemLayout} label="数据域分隔符">
			              {(
			              	<div>
			                 <div  className="left w90"><Input placeholder="," /></div>
			                  <span className="ant-form-text"> <i className=" icon-question-sign"></i></span>
			                </div>
			              )}
			          </FormItem>
			          <FormItem {...formItemLayout} label="数据域包围符">
			              {(
			              	<div>
			                 <div  className="left w90"><Input placeholder="''" /></div>
			                  <span className="ant-form-text"> <i className=" icon-question-sign"></i></span>
...
const MyAddCsv = Form.create()(AddCsv);
export default MyAddCsv;