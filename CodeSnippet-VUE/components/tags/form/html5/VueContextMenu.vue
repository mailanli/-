...
<style>
  ...
  .vue-contextmenu-listWrapper .context-menu-list button:hover {
    ...
    color: #ffffff;
    border-radius: 4px;
    background: -webkit-linear-gradient(bottom, #80C5F9 , #66BBFB); /* Safari 5.1 - 6.0 */
    background: -o-linear-gradient(bottom, #80C5F9, #66BBFB); /* Opera 11.1 - 12.0 */
    background: -moz-linear-gradient(bottom, #80C5F9, #66BBFB); /* Firefox 3.6 - 15 */
    background: linear-gradient(to bottom, #80C5F9 , #66BBFB);
  }
</style>
