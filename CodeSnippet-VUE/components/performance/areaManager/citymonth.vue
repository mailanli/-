...
import { citydetail } from '../common/muck.js'
...
export default {
  ...
  methods: {
    getParams() {
      ...
      if (this.$route.path == '/areaManagerCityMonth') {
    ...
    processUserData(listData, month) {
      ...
      // // 局域-环比值
      // let _ringThan = parseInt(_itemList[month].scoreInfo.num || 0)
